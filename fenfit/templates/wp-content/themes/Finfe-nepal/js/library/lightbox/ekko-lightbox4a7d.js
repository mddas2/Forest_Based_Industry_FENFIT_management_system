		 ...
		 1: [function (require, module, exports) {
			 ...
			 (function (global, factory) {
				 ...
				 Plugin.prototype.structure = function () {
					 ...
					 template = '<div class="lg-outer ' + this.s.addClass + ' ' + this.s.startClass + '">' + '<div class="lg" style="width:' + this.s.width + '; height:' + this.s.height + '">' + '<div class="lg-inner">' + list + '</div>' + '<div class="lg-toolbar group">' + '<span class=""><i class="fa fa-times-circle" aria-hidden="true"></i></span> ' + '</div>' + controls + subHtmlCont + '</div>' + '</div>';
